...
export default function CreateRoom() {
  ...
  return (
    <main className="relative isolate px-6 pb-28 pt-2 md:px-12 md:pb-32 md:pt-4">
      ...
      <div className="pointer-events-none fixed -bottom-16 left-[8%] -z-10 h-md w-md rounded-full bg-[radial-gradient(circle,rgba(59,130,246,0.18)_0%,rgba(2,6,23,0)_72%)] blur-3xl" />
      ...
      <section className="mx-auto w-full max-w-7xl">
        <div className="rounded-2xl border border-white/10 bg-[linear-gradient(160deg,rgba(8,14,30,0.9),rgba(17,24,39,0.55))] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] md:p-8">
          <div className="grid gap-8 xl:grid-cols-[minmax(280px,360px)_minmax(0,1fr)] xl:items-start">
            <aside className="space-y-5 xl:sticky xl:top-6">
              ...
              {createdRoom ? (
                <div className="rounded-xl border border-emerald-300/30 bg-emerald-400/10 p-5">
                  <p className="text-base font-semibold text-emerald-200">Tạo phòng thành công!</p>
            ...
            {!createdRoom ? (
              <form className="min-w-0 space-y-5 rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(11,18,36,0.92),rgba(7,11,22,0.88))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] md:p-6" onSubmit={handleSubmit}>
                {error ? (
